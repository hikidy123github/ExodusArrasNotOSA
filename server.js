        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case 'L': { // level up cheat
                    ...
                    case "PassiveMode":
            {
             if (socket.key === process.env.SECRET || socket.key === process.env.SUPERSECRET){
    ...
    break;
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('Hold "N" to level up instantly!');
                    body.sendMessage('Hope you like the game.');
...
var maintainloop = (() => {
            ...
            if (timer > 6000 && ran.dice(16000 - timer)) {
                ...
                switch (ran.chooseChance(40, 1)) {
                    case 0: 
                        ...
                        break;
                    case 1: 
                        choice = [[Class.palisade, Class.fallenbooster, Class.homingdjynn], 1, 'castle', 'norm']; 
    ...
    let spawnCrasher = census => {
        if (ran.chance(1 -  0.5 * census.crasher / room.maxFood / room.nestFoodAmount)) {
            ...
            let type = (ran.dice(80)) ? ran.choose([Class.sentrySwarm]) : ran.choose([Class.crasher, Class.crasher2, Class.crasher3, Class.jewel, Class.no]);
            let o = new Entity(spot);
                o.define(type);
                o.team = -100;
        }
        ...
        return () => {
            ...
            // Bots
                if (bots.length < bot_count) {
                  ...
                  let possibilities = [];
                  for(let i=1; i <= 4; i++){
                    room['bas' + i].forEach((loc) => possibilities.push(i)); 
                  }
                  let colorTeams = [10, 11, 12, 15]
